...
[assembly: Permission(Name = "com.Sanhedrin.PhoneTag.permission.C2D_MESSAGE")]
[assembly: UsesPermission(Name = "com.Sanhedrin.PhoneTag.permission.C2D_MESSAGE")]
[assembly: UsesPermission(Name = "com.google.android.c2dm.permission.RECEIVE")]
namespace PhoneTag.XamarinForms.Droid.PushNotifications
{
    //You must subclass this!
    [BroadcastReceiver(Permission = Constants.PERMISSION_GCM_INTENTS)]
    [IntentFilter(new string[] { Constants.INTENT_FROM_GCM_MESSAGE }, Categories = new string[] { "com.Sanhedrin.PhoneTag" })]
    [IntentFilter(new string[] { Constants.INTENT_FROM_GCM_REGISTRATION_CALLBACK }, Categories = new string[] { "com.Sanhedrin.PhoneTag" })]
    [IntentFilter(new string[] { Constants.INTENT_FROM_GCM_LIBRARY_RETRY }, Categories = new string[] { "com.Sanhedrin.PhoneTag" })]
    public class GcmBroadcastReceiver : GcmBroadcastReceiverBase<PushHandlerService>
    {
        ...
        public static string[] SENDER_IDS = new string[] { Keys.PhoneTagProjectNumber };
    ...
    public class PushHandlerService : GcmServiceBase
    {
        ...
        private const string TAG = "GCM-SAMPLE";
        ...
        protected override void OnRegistered(Context context, string registrationId)
        {
            ...
            initApp42PushNotifications(registrationId);
        ...
        private void initApp42PushNotifications(string i_Token)
        {
            ...
            try
            {
                PushService.StoreDeviceToken("DudeTest1", i_Token, DeviceType.ANDROID);
            }
            catch (Exception e)
            {
