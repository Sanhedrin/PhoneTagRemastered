        ...
        public void SurfaceCreated(ISurfaceHolder holder)
        {
            try
            {
                if (Preview != null)
                {
                    ...
                    cameraParameters.Set("jpeg-quality", 70);
                    cameraParameters.PictureFormat = Android.Graphics.ImageFormatType.Jpeg;
                    Camera.Size pictureSize = GetOptimalPreviewSize(cameraParameters.SupportedPictureSizes, 2048, 1232);
                    cameraParameters.SetPictureSize(pictureSize.Width, pictureSize.Height);

                    Preview.SetParameters(cameraParameters);
