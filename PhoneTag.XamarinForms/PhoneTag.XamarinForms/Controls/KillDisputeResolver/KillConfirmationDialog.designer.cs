            ...
            else
            {
                ...
                if (displayTip)
                {
                    bool understood = await TrailableContentPage.CurrentPage.DisplayAlert("Kill Confirmations",
                        $"When a player shoots you, you will be shown the shot they've taken of you, and be given a chance to confirm or deny the shot, this is done to prevent cheating.{Environment.NewLine}If the shot captured you in it, press the confirm button.{Environment.NewLine}If you don't think you were rightfully killed, press the deny button;{Environment.NewLine}Denying will send a dispute to the rest of the players, showing the shot image and letting everyone vote on the result. If the majority of players vote to keep you alive, the attacker will be killed instead as a penalty.", "Don't show again", "Ok");
