...
namespace PhoneTag.XamarinForms.Controls.MapControl
{
    ...
    /// </summary>
    class GameMap : GameMapDisplay
    {
        public GameMap(Position i_GameLocation, double i_GameRadius, double i_ZoomRadius) : base(i_GameLocation, i_GameRadius, i_ZoomRadius)
        {
        }
    }
}
